...
export default function Details() {
    ...
    const depositAptVault = async(event: any) =>{
        console.log("Deposit vault DigiTrust")
        if (!account) return [];
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="mt-8">
                                                <div className="space-y-4">
                                                    ...
                                                    <button onClick={depositAptVault} className="flex w-full items-center justify-center gap-x-3 rounded-[10px] bg-blue-600 py-4 text-white duration-200 hover:bg-blue-500">
                                                        <span>
                                                            <svg
                                                                width="24"
                                                                height="24"
